...
export function LoginForm({
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setError(error instanceof Error ? error.message : "Unable to sign in. Please check your credentials.");
    } finally {
      setIsLoading(false);
    }
  };
        ...
        <CardContent className="grid p-0 md:grid-cols-2">
          ...
          <div className="p-6 md:p-8 flex flex-col justify-center bg-background">
            <CardHeader className="flex flex-col items-center space-y-2 text-center p-0 mb-8">
              ...
              <CardDescription>
                Sign in to access the official inventory management system of the Department of Trade and Industry.
              </CardDescription>
            </CardHeader>
